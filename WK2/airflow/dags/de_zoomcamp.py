...
from de_zoomcamp.extract_data_from_url import extract_green_taxi_2020_last_quarter_data_from_api
...
def extract_data_from_url() -> DataFrame:
    ...
    return extract_green_taxi_2020_last_quarter_data_from_api()
